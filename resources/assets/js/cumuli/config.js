(function ($) {
  ...
  $.extend($.cumuli.config, {
    datagrid: {
      ...
      onBeforeLoad: function (param) {
        if (param && param.rows) $.cookie('datagrid-pageSize', param.rows, {expires: 30});
      }
    }
  });
  ...
  $.extend($.cumuli.config, {
    propertygrid: {
      ...
      remoteFilter: false,
      onBeforeLoad: function (param) {
        if (param && param.rows) $.cookie('propertygrid-pageSize', param.rows, {expires: 30});
      }
    }
  });
  ...
  $.extend($.cumuli.config, {
    treegrid: {
      ...
      remoteFilter: false,
      onBeforeLoad: function (param) {
        if (param && param.rows) $.cookie('treegrid-pageSize', param.rows, {expires: 30});
      }
    }
  });
